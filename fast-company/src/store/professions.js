...
const { professionsRequested, professionsReceved, professionsRequestFaild } =
    actions;
...
export const getProfessionsById = (profId) => (state) => {
    if (state.professions.entities) {
        const prof = state.professions.entities.find((el) => el._id === profId);
        // console.log(prof);
        return prof;
    }
    return null;
