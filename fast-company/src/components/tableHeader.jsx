...
const TableHeader = ({ onSort, selectedSort, columns }) => {
    ...
    const renderIcon = (selectedSort, currentColumn) => {
        return (
            currentColumn.path === selectedSort.path 
                ? selectedSort.order === "desc" 
                    ? <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" 
                        className="bi bi-arrow-down" viewBox="0 0 16 16">
                        <path fillRule="evenodd" d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 
                    ...
                    : <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" 
                        ...
                        <path fillRule="evenodd" d="M8 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 
        ...
        <thead>
            <tr>
                {Object.keys(columns).map((column) => (
                    ...
                    >
                        {columns[column].name}
                        {renderIcon(selectedSort, columns[column])}
                    </th>
                ))}
            </tr>
        </thead>
